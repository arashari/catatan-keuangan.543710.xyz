...
const I18N: Record<Lang, Dict> = {
  id: {
    ...
    tx_created: 'Tercatat', tx_updated: 'Transaksi diperbarui', tx_deleted: 'Transaksi dihapus',
    tpl_created: 'Pintasan ditambahkan', tpl_updated: 'Pintasan diperbarui', tpl_deleted: 'Pintasan dihapus',
    cat_created: 'Kategori ditambahkan', cat_updated: 'Kategori diperbarui', cat_deleted: 'Kategori dihapus',
    reset_data: 'Reset Data', reset_desc: 'Hapus semua transaksi · kategori & pintasan kembali ke bawaan',
    reset_confirm: 'SEMUA transaksi akan dihapus, dan kategori & pintasan kembali ke bawaan. Tindakan ini tidak bisa dibatalkan. Lanjutkan?',
    reset_done: 'Data berhasil direset',
    ...
    siklus: 'Siklus', siklus_sub: 'Pantau jarak pembelian rutin', add_siklus: 'Tambah siklus',
    siklus_field: 'Siklus (opsional)', siklus_pre: 'Siklus bawaan', siklus_none: 'Tanpa siklus',
    nav_siklus: 'Siklus', empty_siklus: 'Belum ada siklus',
    siklus_empty_tagged: 'Belum ada pembelian yang ditandai siklus',
    siklus_created: 'Siklus ditambahkan', siklus_updated: 'Siklus diperbarui', siklus_deleted: 'Siklus dihapus',
    siklus_delete: 'Hapus siklus ini? Transaksi yang ditandai tetap ada.',
    siklus_last: 'Terakhir', siklus_next: 'Berikutnya', siklus_est: 'Perkiraan',
    siklus_times: '× tercatat', siklus_no_est: 'Belum ada perkiraan',
    siklus_history: 'Riwayat pembelian', siklus_total: 'Total', siklus_first: 'Pembelian pertama',
  },
  en: {
    ...
    tx_created: 'Recorded', tx_updated: 'Transaction updated', tx_deleted: 'Transaction deleted',
    tpl_created: 'Shortcut added', tpl_updated: 'Shortcut updated', tpl_deleted: 'Shortcut deleted',
    cat_created: 'Category added', cat_updated: 'Category updated', cat_deleted: 'Category deleted',
    reset_data: 'Reset Data', reset_desc: 'Delete all transactions · restore default categories & shortcuts',
    reset_confirm: 'ALL transactions will be deleted, and categories & shortcuts restored to defaults. This cannot be undone. Continue?',
    ...
    siklus: 'Cycles', siklus_sub: 'Track how far apart routine purchases are', add_siklus: 'Add cycle',
    siklus_field: 'Cycle (optional)', siklus_pre: 'Default cycle', siklus_none: 'No cycle',
    nav_siklus: 'Cycles', empty_siklus: 'No cycles yet',
    siklus_empty_tagged: 'No purchases tagged with a cycle yet',
    siklus_created: 'Cycle added', siklus_updated: 'Cycle updated', siklus_deleted: 'Cycle deleted',
    siklus_delete: 'Delete this cycle? Tagged transactions are kept.',
    siklus_last: 'Last', siklus_next: 'Next', siklus_est: 'Estimate',
    siklus_times: '× recorded', siklus_no_est: 'No estimate yet',
    siklus_history: 'Purchase history', siklus_total: 'Total', siklus_first: 'First purchase',
  },
}
